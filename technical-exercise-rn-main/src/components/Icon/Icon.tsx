...
const Icon: FC<IconProps> = ({ name, style, fill, height, width }) => {
  switch (name) {
    case "tick":
      return (
        <Svg
        ...
        >
          <Path
            d="M5.86 13a1 1 0 01-.73-.32L.27 7.51a1.001 1.001 0 011.46-1.37l4.12 4.39 8.41-9.2a1 1 0 111.48 1.34l-9.14 10a1 1 0 01-.73.33h-.01z"
            fill={fill || "#F7F7F7"}
          />
        </Svg>
      );
